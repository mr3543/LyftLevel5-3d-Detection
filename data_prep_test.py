...
def prepare_training_data_for_scene(first_sample_token, output_folder, bev_shape, voxel_size, 
        z_offset,num_sweeps,min_distance,level5data):
    """
...
if __name__ == '__main__':
    ...
    test_data_folder = cfg.DATA.TEST_DATA_FOLDER
    ...
    for df, data_folder in [(test_df, test_data_folder)]:
        ...
        process_func = partial(prepare_training_data_for_scene,
                           ...
                           z_offset=z_offset,num_sweeps=num_sweeps,
                           min_distance=min_distance,level5data=l5d)
